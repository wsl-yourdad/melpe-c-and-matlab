...
all: encoder decoder libmelpe.a

encoder: encoder.c $(LOBJECTS)
	gcc $(CFLAGS) $(LOBJECTS) encoder.c -o encoder $(LIBS)

decoder: decoder.c $(LOBJECTS)
	gcc $(CFLAGS) $(LOBJECTS) decoder.c -o decoder $(LIBS)
